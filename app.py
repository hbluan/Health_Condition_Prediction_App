...
def get_weight(n_clicks, age_group, gender, race, height, weight, college, drink_milk, household_size, health_condition, fast_food, nutrition_info, pressure_check, family_heart, family_diabetes, family_osteoporosis, sit_hour, sleep_hour, smoke_100, drink_days, cost_food, cost_nonfood, cost_restaurant):
    try:
        ...
        user_input = [age_group, gender, race, height, weight, bmi, college, drink_milk, household_size, health_condition, fast_food, nutrition_info, pressure_check, family_heart, family_diabetes, family_osteoporosis, sit_hour, sleep_hour, smoke_100, drink_days, cost_food, cost_nonfood, cost_restaurant]
